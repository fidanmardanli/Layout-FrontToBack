#pragma checksum "C:\Users\marda\Desktop\Code\asp.net\Layout-ViewStart-ViewImport-Models-ViewModels-FrontToBack\Layout-FrontToBack\Layout-FrontToBack\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "096badde2ed5cf354904ecf9e06aac8eb624f20c"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"096badde2ed5cf354904ecf9e06aac8eb624f20c", @"/Views/Home/Index.cshtml")]
    ...
    #nullable disable
    {
        ...
        {
#nullable restore
#line 1 "C:\Users\marda\Desktop\Code\asp.net\Layout-ViewStart-ViewImport-Models-ViewModels-FrontToBack\Layout-FrontToBack\Layout-FrontToBack\Views\Home\Index.cshtml"
...
#nullable disable
                    ...
                    <div class=""carousel-item active"">
                        ...
                        <div class=""py-5 row d-flex align-items-center"">
                            <div class=""banner-content col-lg-8 col-8 offset-2 m-lg-auto text-left py-5 pb-5"">
                                <h1 class=""banner-heading h");
            WriteLiteral(@"1 text-secondary display-3 mb-0 pb-5 mx-0 px-0 light-300 typo-space-line"">
                                ...
                                <a class=""banner-button btn rounded-pill btn-outline-primary btn-lg px-4"" hr");
            WriteLiteral(@"ef=""#"" role=""button"">Get Started</a>
                            </div>
                        </div>
                    ...
                    <div class=""carousel-item"">
                        ...
                        <div class=""py-5 row d-flex align-items-center"">
                            <div class=""banner-content col-lg-8 col-8 offset-2 m-lg-auto text-left py-5 pb-5"">
                                ...
                                <a class=""banner-");
            WriteLiteral(@"button btn rounded-pill btn-outline-primary btn-lg px-4"" href=""#"" role=""button"">Get Started</a>
                            </div>
                        </div>
                        ...
                        <div class=""py-5 row d-flex align-items-center"">
                            <div class=""banner-content col-lg-8 col-8 offset-2 m-lg-auto text-left py-5 pb-5"">
                                ...
                                <p class=""banner-body text-muted py-3"">
                                    ...
                                    irure dolor in reprehenderit in voluptate veli");
            WriteLiteral(@"t esse cillum
    ...
    <section class=""service-wrapper py-3"">
        <div class=""container-fluid pb-3"">
            ...
            <p class=""service-footer col-10 offset-2 col-lg-9 offset-lg-3 text-start pb-3 text-muted px-2"">
                You are free to use this template for your commercial or business websites. You are not allowed to re-distribute this template ZIP file on any template collection websites. It is too easy to illegally cop");
            WriteLiteral(@"y and repost this template.
            </p>
        </div>
        ...
        <div class=""service-tag py-5 bg-secondary"">
            <div class=""col-md-12"">
                <ul class=""nav d-flex justify-content-center"">
                    ...
                    <li class=""nav-item mx-lg-4"">
                        <a c");
            WriteLiteral(@"lass=""filter-btn nav-link btn-outline-primary rounded-pill text-light px-4 light-300"" href=""#"" data-filter="".branding"">Branding</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <section class=""container overflow-hidden py-5"">
        <div class=""row gx-5 gx-sm-3 gx-lg-5 gy-lg-5 gy-3 pb-3 projects"">
            ...
            <div class=""col-xl-3 col-md-4 col-sm-6 project ui graphic"">
        ");
            WriteLiteral(@"        <a href=""#"" class=""service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0"">
            ...
            <div class=""col-xl-3 col-md-4 col-sm-6 project ui graphic"">
                <a href=""#"" class=""service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0"">
                    <img class=""card-img"" src=""./assets/img/serv");
            WriteLiteral(@"ices-05.jpg"" alt=""Card image"">
                    <div class=""service-work-vertical card-img-overlay d-flex align-items-end"">
                        <div class=""service-work-content text-left text-light"">
            ...
            <div class=""col-xl-3 col-md-4 col-sm-6 project branding"">
                <a href=""#"" class=""service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0"">
                    ...
                    <div class=""service-work-vertical card-img-overlay d-flex align-items-end"">
                        <div class");
            WriteLiteral(@"=""service-work-content text-left text-light"">
    ...
    <section class=""py-5 mb-5"">
        <div class=""container"">
            ...
            WriteLiteral(@"
                ...
                <div class=""col-md-4 mb-3"">
         ");
            WriteLiteral(@"           <a href=""#"" class=""recent-work card border-0 shadow-lg overflow-hidden"">
                ...
                <div class=""col-md-4 mb-3"">
                    <a href=""#"" class=""recent-work card border-0 shadow-lg overflow-hidden"">
                        ...
                        <div class=""recent-work-vertical card-img-overlay d-flex align-items-end"">
                            <div class=""recent-work-content text-start mb-3 ml-3 text-dark"">
                                <h3 c");
            WriteLiteral(@"lass=""card-title light-300"">Branding</h3>
